    ...
    declare namespace Db {
        ...
        namespace Invoices {
            ...
            namespace Invoices {
                ...
                export const HeadCodeName: string;
                export const Id: string;
                export const InsuranceCoAdd: string;
                export const InsuranceCoCit: string;
                export const InsuranceCoName: string;
        ...
        namespace Vehicles {
            ...
            namespace Vehicles {
                ...
                export const BrandDeleteDate: string;
                export const BrandDeleteUserId: string;
                export const BrandDescription: string;
                export const BrandInsertDate: string;
                export const BrandInsertUserId: string;
                export const BrandIsActive: string;
                export const BrandName: string;
                export const BrandUpdateDate: string;
                export const BrandUpdateUserId: string;
                export const CcRating: string;
                export const ChassisNo: string;
                export const Color: string;
                export const ColorName: string;
                export const CountryOfOrigin: string;
                export const CountryOfOriginDeleteDate: string;
                export const CountryOfOriginDeleteUserId: string;
                export const CountryOfOriginInsertDate: string;
                export const CountryOfOriginInsertUserId: string;
                export const CountryOfOriginIsActive: string;
                export const CountryOfOriginName: string;
                export const CountryOfOriginUpdateDate: string;
                export const CountryOfOriginUpdateUserId: string;
                export const CustomerAddress: string;
                export const CustomerCityId: string;
                export const CustomerContactName: string;
                export const CustomerContactTitle: string;
