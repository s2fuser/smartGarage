...
namespace SmartERP.Purchases.Entities
{
    ...
    public sealed class PurchasesRow : Row<PurchasesRow.RowFields>, IIdRow, INameRow
    {
        ...
        //[DisplayName("GstPrice"), NotNull]
        //public Double? GstPrice
        //{
        //    get { return Fields.GstPrice[this]; }
        //    set { Fields.GstPrice[this] = value; }
        //}
