...
namespace SmartERP
{
    ...
    public class ReportController : Controller
    {
        ...
        private byte[] RenderAsPdf(IReport report, string key, string opt)
        {
            ...
            var assemblyPath = typeof(ReportController).Assembly.Location.Replace("SmartERP.Web.dll", "");
            var wkhtmlPath = System.IO.Path.Combine(assemblyPath, "App_Data\\Reporting\\wkhtmltopdf.exe");
