...
{
    [ConnectionKey("Default"), Module("Bookings"), TableName("[dbo].[VehicleCourtesyBooking]")]
    [DisplayName("Vehicle Courtesy Booking"), InstanceName("Vehicle Courtesy Booking")]

    [ReadPermission(PermissionKeys.VehicleCourtesyBooking.View)]
    [InsertPermission(PermissionKeys.VehicleCourtesyBooking.Create)]
    [UpdatePermission(PermissionKeys.VehicleCourtesyBooking.Update)]
    [DeletePermission(PermissionKeys.VehicleCourtesyBooking.Delete)]

    [LookupScript("Bookings.VehicleCourtesyBooking", Permission = PermissionKeys.VehicleCourtesyBooking.View)]
