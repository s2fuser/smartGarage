...
namespace SmartERP.Invoices {
    ...
    export class InvoiceItemsEditor extends Common.GridEditorBase<InvoiceItemsRow> {
        ...
        protected getDisplayName() { return "Customers.CustomersRow" }
        ...
        protected validateEntity(row: InvoiceItemsRow, id: number) {
