...
{
    [ConnectionKey("Default"), Module("JobCards"), TableName("[dbo].[GatePasses]")]
    [DisplayName("Gate Passes"), InstanceName("Gate Passes")]

    [ReadPermission(PermissionKeys.GatePasses.View)]
    [InsertPermission(PermissionKeys.GatePasses.Create)]
    [UpdatePermission(PermissionKeys.GatePasses.Update)]
    [DeletePermission(PermissionKeys.GatePasses.Delete)]

    [LookupScript("JobCards.GatePasses", Permission = PermissionKeys.GatePasses.View)]
    public sealed class GatePassesRow : Row<GatePassesRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Job Card"), NotNull, ForeignKey("[dbo].[JobCards]", "Id"), LeftJoin("jJobCard"), TextualField("JobCardWorkOrderNo")]
        ...
        [LookupEditor(typeof(VehiclesRow))]
        ...
        [DisplayName("Job Card Work Order No"), Expression("jJobCard.[WorkOrderNo]")]
