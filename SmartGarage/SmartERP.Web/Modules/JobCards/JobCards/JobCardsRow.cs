...
{
    [ConnectionKey("Default"), Module("JobCards"), TableName("[dbo].[JobCards]")]
    ...
    [LookupScript("JobCards.JobCards", Permission = PermissionKeys.JobCards.View)]
    public sealed class JobCardsRow : Row<JobCardsRow.RowFields>, IIdRow, INameRow
    {
        [DisplayName("Id"), Identity, IdProperty, NameProperty]
        public Int64? Id
        {
            get => fields.Id[this];
        ...
        [DisplayName("Work Order No"), Size(50), QuickSearch]
        ...
        [LookupEditor(typeof(VehiclesRow), InplaceAdd = true, CascadeField = "CustomerId", CascadeFrom = "Customer"), LookupInclude]
        ...
        [DisplayName("Customer Name"), Expression("jCustomer.[Name]"), LookupInclude]
        ...
        [DisplayName("Vehicle Vehicle Registration"), Expression("jVehicle.[VehicleRegistration]"), LookupInclude]
