...
using MyRepository = SmartERP.JobCards.Repositories.JobCardsRepository;
using MyRow = SmartERP.JobCards.Entities.JobCardsRow;
using SelectPdf;
...
namespace SmartERP.JobCards.Endpoints
{
    ...
    public class JobCardsController : ServiceEndpoint
    {
        ...
        public IActionResult Email(Request contentRequest)
        {
            ...
            {
                Attachment attachment = new Attachment(memoryStream, "JobCardBill.pdf", "application/pdf");
